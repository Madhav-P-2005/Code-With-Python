...
print(marks, type(marks))     # Output :-  {'Harry': 100, 'Shubam': 56, 'Rohan': 23} <class 'dict'>
...
print("Keys are :- ",marks.keys())         # Output :-   Keys are :-  dict_keys(['Harry', 'Shubam', 'Rohan'])



# 2) Values() Method :- Returns a view object that displays a list of all the values in the dictionary.

print("Values are :- ",marks.values())    # Output :-  Values are :-  dict_values([100, 56, 23])
...
print(marks)                              # Output :-  {'Harry': 99, 'Shubam': 56, 'Rohan': 23, 'Renuka': 100}
