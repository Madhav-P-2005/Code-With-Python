...
'''
   ...
   3) The general format of a slice is:-   Syntax :- arrayname[start:stop:stride]
   ...
   📌) The syntax for using this method is  :-  slice(start, stop[, step])
...
1) With one parameter :- Default values for start, stop and step are equal to 0, length of the array, and 1
