...
1) Python has 7 major categories of data types, including: Text, Numeric, Sequence, Mapping, Set, Boolean, and Binary types.
...
# 1)  Text Type   :-      str  -->  Used to represent text data.
...
# 2) Numeric Types  :-    a) int  -->  Represents integer numbers.
...
# b) float -->  Represents floating-point numbers.
...
# c) complex -->   Represents complex numbers.
...
# 3)  Sequence Types :-    a) list -->  Ordered, mutable collection of items.
...
# 4) Mapping Type    :-     dict  -->  Unordered collection of key-value pairs.
...
# 5) Set Types  :-      a) set  -->   Unordered collection of unique items.
...
# 6)  Boolean Type :-   a) bool  -->  Represents Boolean values (True or False).
...
# 7) Binary Types  :-    a) bytes  -->   Represents binary data.
...
# b) bytearray -->  Mutable version of bytes.
...
# c) memoryview :-  Allows read and write access to the internal data of an object that supports the buffer protocol.
...
# 8) None Type   :-    NoneType -->  Represents the absence of a value.
